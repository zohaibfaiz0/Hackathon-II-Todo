      ...
      <div style={{ width: '100%', maxWidth: 400, padding: 24 }}>
        <div style={{ background: '#fff', borderRadius: 12, padding: 32, boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            ...
            <h1 style={{ fontSize: 24, fontWeight: 700, color: '#1e293b', margin: 0 }}>Welcome back</h1>
            <p style={{ fontSize: 14, color: '#64748b', marginTop: 8 }}>Sign in to your account</p>
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: '#64748b', marginTop: 20 }}>
            ...
            <Link href="/auth/signup" style={{ color: '#6366f1', textDecoration: 'none', fontWeight: 500 }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
